<div class="modal fade" id="modal-d-municipio{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{ route('municipio.destroy', $item->id) }} " class="formulario-eliminar" method="POST">
                    @csrf
                    @method('DELETE')
