            ...
            <div class="modal-body">
                <form method="POST" action="{{ route('registro.update', $item->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input name="folio" type="text" class="form-control" id="folio"
                            placeholder="Escribe Folio" required value="{{ $item->folio }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="comunidad" class="form-select" id="comunidad">
                            @foreach ($comunidades as $items)
                                <option @if ($item->comunidad_id == $items->id) {{ 'selected' }} @endif
                                    value="{{ $items->id }}">
                    ...
                    <div class="form-group">
                        ...
                        <select name="producto" class="form-select" id="categoria">
                            @foreach ($productos as $items)
                                <option @if ($item->producto_id == $items->id) {{ 'selected' }} @endif
                                    value="{{ $items->id }}">
                                    {{ $items->nombre }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="cantidad_produccion" id="cantida_produccion" type="number"
                            placeholder="Escribe Cantidad Producción" required="true" aria-required="true"
                            min="0" step="any" value="{{ $item->cantidad_produccion }}" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="um_produccion" class="form-select" id="um_produccion">
                            @foreach ($um_produccion as $items)
                                <option @if ($item->um_produccion_id == $items->id) {{ 'selected' }} @endif
                                    value="{{ $items->id }}">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="cantidad_terreno" id="cantida_terreno" type="number"
                            placeholder="Escribe Cantidad de Terreno" required="true" aria-required="true"
                            min="0" step="any" value="{{ $item->cantidad_terreno }}" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select name="um_terreno" class="form-select" id="um_terreno">
                            @foreach ($um_produccion as $items)
                                <option @if ($item->um_terreno->id == $items->id) {{ 'selected' }} @endif
                                    value="{{ $items->id }}">
                                    {{ $items->unidad_medida }}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="desperdicio" id="desperdicio" type="number"
                            placeholder="Escribe Cantidad de desperdicio" required="true" aria-required="true"
                            min="0" step="any" value="{{ $item->desperdicio }}" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" name="ventas" id="ventas" type="number"
                            placeholder="Escribe Cantidad de Terreno" required="true" aria-required="true"
                            min="0" step="any" value="{{ $item->venta }}" />
                    </div>
